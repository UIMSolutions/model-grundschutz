module models.bsi.processes.process;

@safe:
import models.bsi;

static this() {
  createEntities[DBSIProcess.namespace] = (Json json) => BSIProcess(json); 
  createEntities["bsiProcess"] = (Json json) => BSIProcess(json); 
}
// 
...
/*       "annotationId":`{"datatype":"UUID", "descriptions":{"en":"Unique identifier of the note."}}`,
  ...
  override string entityClass() { return "bsiProcess"; }
  override string entityClasses() { return "bsiProcesses"; }
