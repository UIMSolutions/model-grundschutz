module models.bsi.entities.riskcategorys.category;

@safe:
import models.bsi;

static this() {
  createEntities[DBSIRiskCategory.namespace] = (Json json) => BSIRiskCategory(json); 
  createEntities["bsiRiskCategory"] = (Json json) => BSIRiskCategory(json); 
}
// 
  class DBSIRiskCategory : DOOPEntity {
  this() { super();
    this.attributes([
...
/*       "annotationId":`{"datatype":"UUID", "descriptions":{"en":"Unique identifier of the note."}}`,
  ...
  override string entityClass() { return "bsiRiskCategory"; }
  override string entityClasses() { return "bsiRiskCategorys"; }
...
auto BSIRiskCategory() { return new DBSIRiskCategory; } 
auto BSIRiskCategory(Json json) { return new DBSIRiskCategory(json); } 
