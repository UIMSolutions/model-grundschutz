...
/*       "annotationId":`{"datatype":"UUID", "descriptions":{"en":"Unique identifier of the note."}}`,
  ...
  override string entityClass() { return "bsiDocument"; }
  override string entityClasses() { return "bsiDocuments"; }
...
auto BSIDocument() { return new DBSIDocument; } 
auto BSIDocument(Json json) { return new DBSIDocument(json); } 
...
public class DocumentenKategorie extends CnATreeElement implements IBSIStrukturKategorie {
	...
	public DocumentenKategorie(CnATreeElement model) {
		super(model);
	}
	
	protected DocumentenKategorie() {
